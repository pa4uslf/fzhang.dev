...
draft = false
title = '“5克盐”的温柔陷阱：你距离真正的高手，到底还剩几步？'
description = '从“5克盐”的故事出发，讨论为什么只会照着教程做事，会让人停留在工具操作员阶段。'
summary = '当我们过度依赖“标准答案”和“最优解”时，往往会失去对原理的理解。真正让人成长的，不是记住数字，而是看懂数字背后的机制。'
categories = ['学习方法']
tags = ['AI', '第一性原理', '学习方法', '认知']
+++
