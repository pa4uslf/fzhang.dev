...
description = '一次关于 Vim 搜索的小问题，为什么会被 AI 一路带偏？这篇文章拆解了 AI 在真实交互中的四类常见盲点。'
summary = '从一个并不复杂的 Vim 提问出发，文章复盘了 AI 如何因迷信“最优解”、不愿怀疑自身前提而持续误判，最终暴露出知识刚性、线性推理和缺少常识校验等问题。'
categories = ['AI思考']
tags = ['AI', 'Vim', '问题排查', '认知偏差']
+++
