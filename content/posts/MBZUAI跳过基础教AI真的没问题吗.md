...
description = '从“先实践还是先打基础”这个老问题切入，重新讨论 AI 时代真正需要补的基础到底是什么。'
summary = '文章并不反对快速上手 AI，而是指出如果只停留在工具层，会很容易成为只会拼装模块的“AI 调包侠”。真正的基础至少包括工具、原理和问题拆解三层。'
categories = ['AI思考']
tags = ['AI', '教育', '基础能力', '学习路径']
+++
你是否有过这样的经历？
